...
public class ProductViewComponent extends VerticalLayout {
    private final Product product;
    private final BasketService basketService;
    public ProductViewComponent(Product product, BasketService basketService, String route) {
        ...
        if(!Objects.equals(getInstructionSrc(product), "")) {
