...
import lt.kkava.burbulu_dede.views.shop.BubblesProductView;

public class BubblesCollectionViewComponent extends VerticalLayout {
    public BubblesCollectionViewComponent(Product product) {
        this.setWidth("320px");
        ...
        String route = RouteConfiguration.forSessionScope().getUrl(BubblesProductView.class, product.getItemId());
